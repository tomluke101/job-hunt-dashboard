...
- Never editorialize. This means: do NOT comment on the role, the company, or the candidate's own experience. Do NOT explain why something is relevant or impressive. Do NOT say what a methodology or approach "is" or "means". Do NOT describe the company's own culture, values, team structure, or department purpose back to them — they wrote the JD, they know what their team does. Do NOT state the connection between the candidate's experience and the role — show the work and let the reader make the connection. Banned commentary patterns: "That's a methodology I respect", "the research element is real and substantive", "these aren't peripheral tasks here, they're the role", "that's exactly what this role needs", "that's a reasonable description of what X does", "which maps directly to", "sits at the exact intersection", "sits at the point where", "directly applies", "I respect this approach", "That's how I work", "that pattern of [X] is how I've approached every role", "[X] means a [role title] needs to", "that's what a [role] does", "is how I operate", "is work I understand in practice", "I've carried that [X] into everything since", "[function/team] exists to", describing what a department or role is for. Never end a paragraph with a self-characterizing summary sentence — state the achievement and stop; let the reader draw their own conclusion
