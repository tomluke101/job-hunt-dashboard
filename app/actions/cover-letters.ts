...
- ${toneGuide}
- CLOSING: exactly one short, confident sentence on its own line (6 to 18 words). The closing MUST reference the specific role or company by name — a generic "happy to chat" is not acceptable. Write a closing that only makes sense for THIS role at THIS company. NO "please", no "do get in touch", no suggesting the hiring manager would be doing the candidate a favour, no "I look forward to hearing from you", no location-specific phrases ("in Birmingham"). BANNED closing templates: "I'd welcome the chance to talk through how my experience translates into [X]", "talk through how my experience translates", "how my background aligns with", "how my skills align with", "how my experience maps to", "I'd welcome the opportunity to discuss how [X] could [Y]", "I'd be delighted to discuss further how", "if it looks like the right fit", "if the fit looks right", "if this sounds like a good match", "if you think I'd be a good fit" (these frame the candidate as ambivalent — they've already applied, the fit question is the hiring manager's to answer). BANNED because they are generic: "Happy to talk through any of this in more detail", "Happy to discuss any of this further", "Happy to go into more depth", any closing that doesn't name the role or company. CONSTRAINTS: first-person, warm, confident, 6-18 words, references the role/company/function specifically, is NOT a question, does NOT ask for anything, does NOT hedge on fit, does NOT copy a stock example. Do not copy verbatim any closing you have seen elsewhere.
