...
- ATTRIBUTION INTEGRITY — never inflate the candidate's contribution beyond what the source text says. Do NOT insert solo-authorship words like "from scratch", "single-handedly", "designed and built myself", "I created", "I architected", or "I built out" unless the CV or skills text explicitly states solo ownership. If the source is ambiguous or implies collaboration ("built", "developed", "implemented"), use neutral verbs that do not overclaim: "worked on", "helped build", "contributed to designing", "was central to", "led the [specific part]". Never upgrade "built X" to "built X from scratch" on your own initiative. When in doubt, understate.
