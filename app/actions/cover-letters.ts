...
3. SELF-CHARACTERISING SUMMARY SENTENCES — be AGGRESSIVE in catching these. If a sentence abstracts concrete activity into a branded noun ("pattern", "approach", "grounding", "foundation", "understanding", "mindset") and then claims the candidate acquired, developed, carries, or applies it, it is banned. The SPECIFIC WORDING DOES NOT MATTER — match by SHAPE. Here are the shapes to catch:
   - "[activity / experience] gave me [a grounding / foundation / understanding / strong sense / feel / instinct] [in / for / of] [abstract noun]". Example hits: "gave me a strong grounding in structured coordination", "gave me a foundation in analytical thinking".
   ...
   - "[X] is the kind of [Y] that translates directly to [Z]", "maps to the kind of work [Z] requires", "underpins both [A] and [B]".
...
6. CLOSING ISSUES — apply the SPEECH TEST: would a real person actually say this sentence out loud to a hiring manager or colleague? If it only exists in formal written correspondence, REWRITE it to something conversational.
   - Over 18 words → shorten to 6-18.
   - Stilted formal stems that no one says out loud: "I'd welcome the chance to discuss", "I'd welcome the opportunity to discuss", "I would welcome the opportunity", "It would be a pleasure to discuss", "I'd be delighted to discuss", "At your earliest convenience". These fail the speech test. REWRITE into a conversational closing: use contractions, simple verbs ("happy to", "glad to", "keen to", "would love to", "let me know", "would be good to"). Examples of the target register (do not copy verbatim, use only as shape references): "Happy to dig into any of this on a call.", "Let me know if you'd like to talk it through.", "Would be good to talk through the [specific thing] with you.", "Really keen to discuss the [named function/role] when you have time.", "Thanks for reading — happy to go into more detail if helpful."
   - Summary stems (rewrite): "My experience in [list]", "I'm confident my experience", "What I can bring to [team]", "I would bring", "I can offer", "Given my background in", "With my experience in".
   - Contains "from day one", "from an early stage", "from the outset", "hit the ground running" — remove the phrase.
   - Formulaic "discuss the [role title] at [Company]" — this is the most common AI-cover-letter closing pattern; rewrite to something more natural.
   FIX: rewrite as a short (6-18 word) forward-action invitation in conversational register that passes the speech test. A good closing sounds like something the candidate would actually say at the end of a phone call.
...
- ${toneGuide}
- CLOSING: exactly one short, confident sentence on its own line, strictly 6-18 words. STRICT LENGTH LIMIT — if the closing is longer than 18 words, shorten it.
  REGISTER — THIS IS THE MOST IMPORTANT CLOSING RULE: the closing must drop half a notch below the formal register of the letter body. It should read like something a real person would actually SAY OUT LOUD to a colleague or hiring manager, not like formal written correspondence. THE SPEECH TEST: would a real human being say this sentence out loud at the end of a meeting or a phone call? If the answer is no — if the sentence only exists in formal written prose — REWRITE it. Use contractions. Use simple conversational verbs ("happy to", "glad to", "keen to", "would love to", "let me know", "would be good to"). Avoid formal written-only phrases ("I'd welcome the chance to discuss", "I would welcome the opportunity to", "I'd be delighted to", "at your earliest convenience", "should you require").
  CLOSING PATTERN LIBRARY — 12 shapes across three registers. Pick ONE and generate a novel sentence in that shape. DO NOT copy any example verbatim; use it only for the shape and register.
    CONVERSATIONAL (preferred default — dropped register, feels most human):
      C1 — "Happy to dig into any of this on a call."
      C2 — "Let me know if you'd like to talk it through."
      C3 — "Glad to chat through the role whenever suits you."
      C4 — "Would be good to talk through [specific thing from letter/JD] with you."
      C5 — "Thanks for reading — happy to go into more detail if helpful."
    ENTHUSIASM-LED (use when the role is a strong fit and the candidate genuinely wants it):
      E1 — "Really keen to discuss the [named role/function] when you have time."
      E2 — "Would love to hear more about the [named team/function] and how I can help."
      E3 — "The [named JD thing] is exactly what I want to be doing next."
    PROFESSIONAL-BUT-ALIVE (slightly more formal but still natural):
      P1 — "I'd welcome the chance to take this further."
      P2 — "Looking forward to talking this through with the team."
      P3 — "Available for a call at any time that works for you."
      P4 — "Glad to discuss the role further whenever convenient."
  VARIATION REQUIREMENT: rotate across registers. If one letter used Conversational, the next should use Enthusiasm-led or Professional-but-alive. Never default to the same shape twice in sequence. Most letters should use a CONVERSATIONAL (C1-C5) or ENTHUSIASM-LED (E1-E3) closing — the Professional-but-alive group is the fallback, not the default.
  BANNED STEMS for the closing (do not start the closing with any of these — they all produce formal written-only boilerplate): "I'd welcome a conversation about", "I'd welcome the opportunity to", "I would welcome the opportunity to", "I'd welcome the chance to discuss how", "My experience in [list]", "I'm confident my experience", "What I can bring to [team]", "I would bring", "I can offer", "I am well-placed to", "Given my background in", "With my experience in", "I believe my [skills/experience] would", "It would be an honour to".
  SPECIFICITY: the closing should reference something from the letter — a named function, a named system the candidate has described, or the role/company — OR be short and warmly generic (C1, C2, C5, P1 style). Avoid formulaic "discuss the [role title] at [Company]" — that is the most common AI-cover-letter closing and it reads as boilerplate. The closing MUST reference the specific role or company by name — a generic "happy to chat" is not acceptable. Write a closing that only makes sense for THIS role at THIS company. The closing is an INVITATION TO SPEAK — not a summary of qualifications, not a recap of the letter, not a three-part self-promotion. CONSTRAINTS: first-person, warm, confident, references the role/company/function specifically, is NOT a question, does NOT ask for anything, does NOT hedge on fit, does NOT list qualifications, does NOT copy a stock example. BANNED closing templates: "I'd welcome the chance to talk through how my experience translates into [X]", "talk through how my experience translates", "how my background aligns with", "how my skills align with", "how my experience maps to", "I'd welcome the opportunity to discuss how [X] could [Y]", "I'd be delighted to discuss further how", "if it looks like the right fit", "if the fit looks right", "if this sounds like a good match", "if you think I'd be a good fit", "Happy to talk through any of this in more detail", "Happy to discuss any of this further", "Happy to go into more depth", "My experience in [A], [B], and [C] would contribute directly to [team] at [Company]", "I'm confident my experience in [A], [B], and [C] [would / will] [Y]" (these are summary statements, not invitations to speak), "from day one", "from an early stage", "from the outset", "hit the ground running", "I would contribute from [time phrase]". Do not copy verbatim any closing you have seen elsewhere.
